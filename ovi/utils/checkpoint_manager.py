...
# Register GGUF file extensions for OVI models
try:
    # Add .gguf extension support to diffusion_models folder
    if 'diffusion_models' in folder_paths.folder_names_and_paths:
        ...
        if isinstance(extensions, (set, dict)):
            # Add .gguf to existing extensions
            if isinstance(extensions, set):
                extensions.add('.gguf')
            elif isinstance(extensions, dict):
                extensions['.gguf'] = None
except Exception:
    pass
...
# Ovi 1.1 Model Variants with different resolutions and durations
OVI_MODEL_SPECS_MAP = {
    "720x720_5s": {
        "source_name": "model.safetensors",
        "target_name": "Ovi-11B-bf16.safetensors",
    ...
    "720x720_5s_fp8": {
        "source_name": "model_fp8_e4m3fn.safetensors",
        "target_name": "Ovi-11B-fp8.safetensors",
        "video_latent_length": 31,
        "audio_latent_length": 157,
        "video_area": 720 * 720,
        "duration_seconds": 5,
    ...
    "960x960_5s": {
        "source_name": "model_960x960.safetensors",
        "target_name": "Ovi-960x960-5s.safetensors",
        "video_latent_length": 31,
        "audio_latent_length": 157,
        "video_area": 960 * 960,
        "duration_seconds": 5,
    ...
    "960x960_10s": {
        "source_name": "model_960x960_10s.safetensors",
        "target_name": "Ovi-960x960-10s.safetensors",
        "video_latent_length": 61,  # Double for 10s!
        "audio_latent_length": 314,  # Double for 10s!
        "video_area": 960 * 960,
        "duration_seconds": 10,
    },
    "960x960_10s_gguf_f16": {
        "source_name": "Ovi-960x960-10s-F16.gguf",
        "target_name": "Ovi-960x960-10s-F16.gguf",
        "video_latent_length": 61,
        "audio_latent_length": 314,
        "video_area": 960 * 960,
        "duration_seconds": 10,
    },
    "960x960_10s_gguf_q4k": {
        "source_name": "Ovi-960x960-10s-Q4_K.gguf",
        "target_name": "Ovi-960x960-10s-Q4_K.gguf",
        "video_latent_length": 61,
        "audio_latent_length": 314,
        "video_area": 960 * 960,
        "duration_seconds": 10,
...
_OVI_VARIANT_JOBS = {
    ...
    "960x960_5s": {
        "repo_id": OVI_MODEL_REPO,
        "subdir": "Ovi",
        "patterns": ["model_960x960.safetensors"],
        "target_name": "Ovi-960x960-5s.safetensors",
        "source_name": "model_960x960.safetensors",
    },
    "960x960_10s": {
        "repo_id": OVI_MODEL_REPO,
        "subdir": "Ovi",
        "patterns": ["model_960x960_10s.safetensors"],
        "target_name": "Ovi-960x960-10s.safetensors",
        "source_name": "model_960x960_10s.safetensors",
    },
    "960x960_10s_gguf_f16": {
        # GGUF F16 - generated locally from safetensors
        "repo_id": OVI_MODEL_REPO,
        "subdir": "",
        "patterns": ["Ovi-960x960-10s-F16.gguf"],
        "target_name": "Ovi-960x960-10s-F16.gguf",
        "source_name": "Ovi-960x960-10s-F16.gguf",
    },
    "960x960_10s_gguf_q4k": {
        # GGUF Q4_K - quantized locally from F16 GGUF
        "repo_id": OVI_MODEL_REPO,
        "subdir": "",
        "patterns": ["Ovi-960x960-10s-Q4_K.gguf"],
        "target_name": "Ovi-960x960-10s-Q4_K.gguf",
        "source_name": "Ovi-960x960-10s-Q4_K.gguf",
    },
}
